...
class BusinessSettingsController extends Controller
{
    ...
    public function payment_update(Request $request, $name)
    {
        ...
        if ($name == 'cash_on_delivery') {
            ...
            $payment = BusinessSetting::where('key', 'plural')->first();
            if (isset($payment) == false) {
                BusinessSetting::query()->insert([
                    'key'        => 'plural',
                    'value'      => json_encode([
                ...
                BusinessSetting::where(['key' => 'plural'])->update([
                    'key'        => 'plural',
                    'value'      => json_encode([
                        'status'   => $request['status'],
                        'mode' => $request['mode'],
                        'plural_mid' => $request['plural_mid'],
                        'plural_access_key'    => $request['plural_access_key'],
                        'plural_secret'    => $request['plural_secret'],
                    ]),
                    'updated_at' => now(),
                ]);
            }
