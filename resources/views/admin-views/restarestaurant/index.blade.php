                ...
                <form method='get' id="search_form">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select id="restaurant_id" name="restaurant_id"
                                    ...
                                    onchange="getAccountData('{{ url('/') }}/admin/restaurant/get-account-data/',this.value,'restaurant')"
                                    class="form-control h--48px" title="Select Restaurant">
                                    @if (request()->has('restaurant_id') && !empty(request()->get('restaurant_id')) && $restaurant)
                                        <option value="{{ request()->get('restaurant_id') }}" selected="selected">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="input-label"
                                    for="start_date">{{ translate('messages.select start date') }}</label>
                                <input class="form-control h--48px datepicker" type="text" name="start_date"
                                    id="start_date" maxlength="191"
                                    value="{{ request()->has('start_date') ? request()->get('start_date') : '' }}"
                                    placeholder="{{ translate('Ex : 2023-2-20') }}" autocomplete="off">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="input-label"
                                    for="end_date">{{ translate('messages.select end date') }}</label>
                                <input class="form-control h--48px datepicker" type="text" name="end_date" id="end_date"
                                    maxlength="191"
                                    value="{{ request()->has('end_date') ? request()->get('end_date') : '' }}"
                                    placeholder="{{ translate('Ex : 2024-12-20') }}" autocomplete="off">
                            </div>
                        </div>
                        {{-- <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="input-label" for="ref">{{ translate('messages.reference') }}<span
                                        class="input-label-secondary"></span></label>
                                <input class="form-control h--48px" type="text" name="ref" id="ref"
                                    value="{{ request()->has('ref') ? request()->get('ref') : '' }}" maxlength="191"
                                    placeholder="{{ translate('Ex : Collect Cash') }}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="payment_by" id="payment_by" class="form-control h--48px select2">
                                    ...
                                    @foreach ($admins as $admin_user)
                                        <option value="{{ $admin_user->id }}"
                                            {{ request()->has('payment_by') && request()->get('payment_by') == $admin_user->id ? 'selected' : '' }}>
                                            {{ $admin_user->f_name }} {{ $admin_user->l_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="mt-3">
                            ...
                            <div class="col-12 text-right">
                                ...
                                <a href=""><button type="button" id="submit_btn"
                                        class="btn btn-secondary margin-right">{{ translate('messages.conform payment:') }}</button></a>
                            </div>
                            {{-- <div class="">
                                        ...
                                        <tr class="thead-light">
                                            <th>
                                                <label class="checkbox-container">
                                                    <input type="checkbox" id="check-all-orders" class=""
                                                        data-checked="0">
