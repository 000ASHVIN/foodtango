                    ...
                    <div class="card shadow--card-2">
                        ...
                        <div class="card-body pb-0">
                            <div class="row">
								...
								<div class="col-md-4 col-12">
                                    <div class="form-group">
                                        <label class="input-label" for="alternate_phone">{{ translate('messages.alternate_phone') }}</label>
                                        <input id="alternate_phone" type="tel" name="alternate_phone" class="form-control h--45px" placeholder="{{ translate('messages.Ex :') }} +9XXX-XXX-XXXX"
                    ...
                    <div class="card shadow--card-2">
                        ...
                        <div class="card-body pb-0">
                            <div class="row">
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        <label class="input-label" for="is_popular">Polupar</label>
                                        <select name="is_popular" id="is_popular" class="form-control h--45px min--45 js-select2-custom"  >
                                            <option value="">{{ translate('messages.select') }} </option>
                                            
                                            <option value="1" {{ $restaurant->is_popular == 1 ? 'selected' : '' }}>{{ translate('messages.yes') }}</option>
                                            <option value="0" {{ $restaurant->is_popular == 0 ? 'selected' : '' }}>{{ translate('messages.no') }}</option>
                                        </select>
                                    </div>
                                </div>
